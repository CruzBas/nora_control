...
import NavLinksCocina from './nav-links-cocina';

export default function SidenavCocina() {
    ...
    const sidebarContent = (
        <>
            <Link href="/dashboardCocina" className="p-5 flex items-center gap-3 group">
            ...
            <NavLinksCocina onLinkClick={() => setMobileOpen(false)} />
