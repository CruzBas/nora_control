                ...
                {pendientes.map(orden => (
                    ...
                    >
                        <div className="flex justify-between items-start mb-4">
                            <div className="w-12 h-12 bg-nora-accent-500/10 border border-nora-accent-500/20 rounded-2xl flex items-center justify-center text-2xl">
                                🍽️
                            </div>
                            <span className="text-xs font-black text-nora-accent-400 bg-nora-accent-500/10 px-2 py-1 rounded-full border border-nora-accent-500/20">
